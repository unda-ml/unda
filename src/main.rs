...
fn main() {
    ...
    let mut new_net: Network = Network::new(vec![2,3,4,1], activations::SIGMOID, 0.1);
    
    new_net = new_net.train_to_loss(inputs, outputs, 0.001, 10000, Mode::Avg, 0.9, 10.0, 3, 10);
